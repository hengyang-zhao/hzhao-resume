...
\usepackage[left=0.75in,top=1.1in,right=0.75in,bottom=1.1in]{geometry} % Document margins
...
\begin{rSection}{Experience}
    ...
    \begin{rSubsection}{Research on Smart Building Energy Reduction with Special Focus on Learning-Based Techniques}{January 2015 -- present}{Research Assistant}{UC Riverside}
    ...
    \item Developed an auxiliary tool to inspect the migration of the
        relationship between browser$*$ thread and the corresponding processor’
        s$*$ status within an interested duration.
...
\begin{enumerate}
    ...
    \item \textbf{Hengyang Zhao}, Daniel Quach, Shujuan Wang, Hai Wang, Haibao
        ...
        Modeling for Energy-Efficient Smart Building Management.''
        International Conference On Computer Aided Design ('15 Invited)

    \item
        \textbf{Hengyang Zhao}, Zhongdong Qi, Shujuan Wang, Kambiz Vafai, Hai
        ...
        Circuits and Systems ('16 Invited)
